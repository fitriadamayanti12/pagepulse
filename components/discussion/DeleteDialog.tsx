      ...
      <div className="relative bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl max-w-md w-full overflow-hidden border-2 border-rose-200/40 animate-in fade-in zoom-in-95 duration-200">
        <div className="p-6 sm:p-7">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              <h3 className="text-xl font-extrabold text-[#3d3530]">Delete Topic</h3>
          ...
          <div className="bg-rose-50/40 rounded-2xl p-4 border border-rose-100/40 mb-6">
            ...
            <p className="text-sm text-[#9b8d80] font-medium mt-2">
              All replies will also be permanently removed.
            </p>
          </div>

          <div className="flex gap-3 justify-end">
            <Button variant="outline" onClick={onCancel}
              className="border-2 border-amber-100/40 text-base font-bold h-11 px-5 rounded-xl bg-white/60 text-[#6b5d50] hover:bg-amber-50/50">Cancel</Button>
            <Button onClick={onConfirm}
              className="bg-gradient-to-r from-rose-400 to-pink-500 hover:from-rose-500 hover:to-pink-600 text-white text-base font-bold h-11 px-5 rounded-xl shadow-lg shadow-rose-200/30">Delete</Button>
          </div>
        </div>
      </div>
    </div>
